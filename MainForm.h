...
namespace Bladestick
{
	...
	private: System::Windows::Forms::ToolStripMenuItem^  ïåðåñîçäàòüToolStripMenuItem;
		...
		System::Void ïåðåñîçäàòüToolStripMenuItem_Click(System::Object^  sender, System::EventArgs^  e);
...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->ïåðåñîçäàòüToolStripMenuItem = (gcnew System::Windows::Forms::ToolStripMenuItem());
			...
			this->ñöåíàToolStripMenuItem->DropDownItems->AddRange(gcnew cli::array< System::Windows::Forms::ToolStripItem^  >(5) {
				this->îáíîâèòüToolStripMenuItem,
					this->ïåðåñîçäàòüToolStripMenuItem, this->toolStripSeparator1, this->ñîõðàíèòüToolStripMenuItem, this->çàãðóçèòüToolStripMenuItem
			});
			...
			// 
			// ïåðåñîçäàòüToolStripMenuItem
			// 
			this->ïåðåñîçäàòüToolStripMenuItem->Name = L"ïåðåñîçäàòüToolStripMenuItem";
			this->ïåðåñîçäàòüToolStripMenuItem->ShortcutKeys = static_cast<System::Windows::Forms::Keys>((System::Windows::Forms::Keys::Control | System::Windows::Forms::Keys::R));
			this->ïåðåñîçäàòüToolStripMenuItem->Size = System::Drawing::Size(184, 22);
			this->ïåðåñîçäàòüToolStripMenuItem->Text = L"Ïåðåñîçäàòü";
			this->ïåðåñîçäàòüToolStripMenuItem->Click += gcnew System::EventHandler(this, &MainForm::ïåðåñîçäàòüToolStripMenuItem_Click);
			// 
			// toolStripSeparator1
			// 
